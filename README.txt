The Simple Calculator- classics is an Android calculator application.
...
This app is now available in the Google Play Store. So you can access it via any 
Android phone or tablet. And you can even install the app, to your device, by
using the browser with the URL below:
https://play.google.com/store/apps/details?id=classics.thesimplecalculator_classics
